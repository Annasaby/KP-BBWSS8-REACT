...
export default function Berita(){
    return(
        ...
        <section className="w-screen flex justify-center items-center mt-20">
            <div className="w-4/5 flex flex-col md:flex-row gap-10 md:gap-0">
                <div className="md:w-4/5 md:pr-24 flex flex-col gap-3">
                ...
                <div className="md:w-1/4 flex flex-col gap-5 items-center">
                    <div className="w-fit">
                        <h3 className="text-2xl font-semibold">BERITA LAINNYA</h3>
                        <hr className="w-1/3 border-t border-2 border-yellow-400" />
                    </div>
                    <div className="flex gap-5">
                        <a className="w-4/5 flex flex-col gap-1" href="berita.html">
