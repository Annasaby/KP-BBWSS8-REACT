...
export default function Footer(){
    return(
        ...
        <footer className="w-screen flex justify-center items-center mt-32 bg-biru">
            <div className="md:w-4/5 flex flex-col md:flex-row justify-between items-center my-5 gap-10 md:gap-0">
                <div className="w-full md:w-fit flex flex-col gap-3">
                    ...
                    <p className="text-sm text-white">Copyright © 2024. TIM KP UNSRI</p>
                ...
                <div className="md:w-1/2 grid grid-cols-1 md:grid-cols-3 gap-y-5 md:gap-y-3 text-white">
                    <div>
                        <h5 className="text-lg font-bold mb-2 md:mb-5">Company</h5>
                    ...
                    <div>
                        <h5 className="text-lg font-bold mb-2 md:mb-5">Support</h5>
                        <div className="flex flex-col gap-2">
